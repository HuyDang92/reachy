        ...
        <section class="product__detail-content">
            <div class="product__detail-left">
                <div class="product-slide">
                    <div class="mySlides">
                        <img src="<?= $CONTENT_URL ?>/imgs/products/adizeropro1.webp" style="width:100%">
                    </div>
                    <div class="mySlides">
                        <img src="<?= $CONTENT_URL ?>/imgs/products/adizeropro2.webp" style="width:100%">
                    </div>
                    <div class="mySlides">
                        <img src="<?= $CONTENT_URL ?>/imgs/products/adizeropro3.webp" style="width:100%">
                    </div>
                    <div class="mySlides">
                        <img src="<?= $CONTENT_URL ?>/imgs/products/adizeropro4.webp" style="width:100%">
                    </div>
                    <div class="mySlides">
                        <img src="<?= $CONTENT_URL ?>/imgs/products/adizeropro5.webp" style="width:100%">
                    </div>
                    <div class="row">
                        <div class="column">
                            <img class="demo cursor" src="<?= $CONTENT_URL ?>/imgs/products/adizeropro1.webp"
                                style="width:100%" onclick="currentSlide(1)" alt="">
                        </div>
                        <div class="column">
                            <img class="demo cursor" src="<?= $CONTENT_URL ?>/imgs/products/adizeropro2.webp"
                                style="width:100%" onclick="currentSlide(2)" alt="">
                        </div>
                        <div class="column">
                            <img class="demo cursor" src="<?= $CONTENT_URL ?>/imgs/products/adizeropro3.webp"
                                style="width:100%" onclick="currentSlide(3)" alt="">
                        </div>
                        <div class="column">
                            <img class="demo cursor" src="<?= $CONTENT_URL ?>/imgs/products/adizeropro4.webp"
                                style="width:100%" onclick="currentSlide(4)" alt="">
                        </div>
                        <div class="column">
                            <img class="demo cursor" src="<?= $CONTENT_URL ?>/imgs/products/adizeropro5.webp"
