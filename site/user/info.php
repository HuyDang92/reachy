                            ...
                            <div class="order__row--right">
                                ...
                                <div class="rating_container">
                                    ...
                                    <form action="<?= $SITE_URL ?>/product/handle_order.php" method="POST"
                                        ...
                                        <div>
                                            <div>
                                                <label for="star1"> <span class="material-icons-outlined"> star_border
                                                    </span> </label>
                                                <label for="star2"> <span class="material-icons-outlined"> star_border
                                                    </span> </label>
                                                <label for="star3"> <span class="material-icons-outlined"> star_border
                                                    </span> </label>
                                                <label for="star4"> <span class="material-icons-outlined"> star_border
                                                    </span> </label>
                                                <label for="star5"> <span class="material-icons-outlined"> star_border
                                                    </span> </label>
                ...
                <div class="order_cancel">
                    <ul class="order__rows--container">
                        ...
                        <li class="order__row">
                            ...
                            <div class="order__row--right">
                                <a href="<?= $SITE_URL ?>/product/handle_order.php?repurchase=<?= $orders_cancel['id_bill'] ?>"
                                    target="frame">
                                    Mua lại
                                </a>
                            </div>
